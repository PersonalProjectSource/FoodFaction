...
use IntentRestAPI\UserBundle\Form\MessageType;
...
class MessageController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $oNotification = $this->container->get('intent_rest_api_user.notification')->SendNotification($oUser);

        $oEm->persist($oNotification);
        $oEm->flush();

        $aoMessages = $oEm->getRepository('IntentRestAPIUserBundle:Message')->findAll();
        $aDataMessageFromJson = array();

        foreach ($aoMessages as $sKey => $oMessage) {
            $aDataMessageFromJson[] = $oMessage->spawnInArray();
        }

        $aMessageDatas = array($aDataMessageFromJson);
        $oResponse = new JsonResponse($aMessageDatas, 200);
     ...
     * @Method("POST")
     * @Template("IntentRestAPIUserBundle:Message:new.html.twig")
     */
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('IntentRestAPIUserBundle:Message')->find($id);
    ...
    */
     ...
     * @Method("PUT")
     * @Template("IntentRestAPIUserBundle:Message:edit.html.twig")
     */
